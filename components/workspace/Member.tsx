...
const Member: React.FC<MemberProps> = ({
  ...
  const { tasks, avatar, name, email } = member;

  const colour = '#5C68FF';

  const completedTasksPercent =
    (tasks ? tasks.completed / tasks.total : 0) * 100;
  ...
  return (
    <div className={`member-card card ${className}`}>
      ...
      <div className="details">
        <div className="avatar relative w-[117px] h-[117px] bg-gray-300 bg-main rounded-full overflow-hidden mx-auto">
